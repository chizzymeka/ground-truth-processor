...
# read file
with open('ground_truth_phase_1.json', 'r') as ground_truth_data_file:
...
def get_modified_line_numbers_as_json():
    ...
    for commit_hash in commit_hashes:
        ...
        for commit in Repository(tomcat_repo, single=commit_hash,
...
def update_ground_truth_json_data():
    ...
    with open("ground_truth_phase_2.json", "w") as output_json_file:
...
if __name__ == '__main__':
    ...
    print('Python script successfully executed for phase 2!')
